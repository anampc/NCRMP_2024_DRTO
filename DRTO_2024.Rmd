...
```{r mosaic, echo=FALSE, out.width = '50%', fig.cap="Figura 5: Diver collecting photos for landscape mosaics", fig.align='center'}
...
```{r BMUs, include=FALSE, out.width = '50%', fig.cap="CAU and BMU pair before retreval after being deployed for three years. CAUs are two parallel PVC plates to quantify settled accretors. BMU is mounted coral skeleton installed at the base of the metal stake and has been encrusted.", fig.align='center'}
